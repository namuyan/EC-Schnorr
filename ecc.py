...
"""class ECcurve:
   # BRAINPOOL224R1 - Brainpool curve over a 224 bit prime field
   ...
   xi = int("D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D", 16)
   yi = int("58AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD", 16)
   q = int("D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F", 16)
   i = int("1", 16)
   fieldSize = 224"""
